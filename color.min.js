/*
 Color conversion functions v1.0.0
 https://github.com/Wolfy87/Color

 Copyright 2011, Oliver Caldwell (flowdev.co.uk)
 Dual licensed under the MIT or GPL Version 2 licenses.
*/
var color={toArray:function(b){var a=null,c=[],d=this.names;if(b instanceof Array)return b;else if(b.indexOf("rgb")===0)c=b.replace(/rgb\(|\)|\s/gi,"").split(",");else if(b.indexOf("#")===0){b=b.slice(1);b.length===3&&(b=b.replace(/([0-9a-f])/ig,"$1$1"));for(a=0;a<3;a++)c.push(parseInt(b.slice(a*2,(a+1)*2),16))}else for(a in d)d.hasOwnProperty(a)&&a===b.toLowerCase()&&(c=[d[a][0],d[a][1],d[a][2]]);for(a=0;a<3;a++)c[a]=parseInt(c[a],10);return c},toRgb:function(b){return"rgb("+this.toArray(b).join(", ")+
")"},toHex:function(b){var a=null;b=this.toArray(b);for(a=0;a<3;a++)b[a]=b[a].toString(16).toUpperCase(),b[a].length===1&&(b[a]="0"+b[a]);return"#"+b.join("")},toName:function(b){var a=null,c=this.names;b=this.toArray(b);for(a in c)if(c.hasOwnProperty(a)&&b[0]===c[a][0]&&b[1]===c[a][1]&&b[2]===c[a][2])return a;return!1},names:{aliceblue:[240,248,255],antiquewhite:[250,235,215],aqua:[0,255,255],aquamarine:[127,255,212],azure:[240,255,255],beige:[245,245,220],bisque:[255,228,196],black:[0,0,0],blanchedalmond:[255,
